CREATE DATABASE sql_bibliotheque;

USE sql_bibliotheque;
...
-- (NULL, 'GUY DE MAUPASSANT', 'Une vie'),
-- (NULL, 'GUY DE MAUPASSANT', 'Bel-Ami '),
-- (NULL, 'HONORE DE BALZAC', 'Le père Goriot'),
-- (NULL, 'ALPHONSE DAUDET', 'Le Petit chose'),
-- (NULL, 'ALEXANDRE DUMAS', 'La Reine Margot'),
-- (NULL, 'ALEXANDRE DUMAS', 'Les Trois Mousquetaires');
