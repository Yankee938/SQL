CREATE DATABASE sql_entreprise; -- Création de la BDD

USE sql_entreprise; -- On se place dans la BDD souhaitée 

CREATE TABLE employes ( -- Création d'une table (entité pour le MCD)
